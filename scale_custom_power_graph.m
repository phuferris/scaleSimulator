function scale_custom_power_graph(prob_sleeping1, prob_sleeping2,prob_sleeping3, sentStatistics);
global initial_power;
global numNodes;
figure;
PowerStat=[sentStatistics.run1_power,sentStatistics.run2_power,sentStatistics.run3_power];
clr=['m','g','y'];
ygap=0.1;
Prob=[prob_sleeping1, prob_sleeping2, prob_sleeping3];
    for n = 1:3           
